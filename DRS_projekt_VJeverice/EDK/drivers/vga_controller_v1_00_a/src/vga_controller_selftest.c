/*****************************************************************************
* Filename:          D:\DRS\KV_Lekic\EDK/drivers/vga_controller_v1_00_a/src/vga_controller_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the vga_controller driver
...
XStatus VGA_CONTROLLER_SelfTest(void * baseaddr_p)
{
  ...
  VGA_CONTROLLER_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = VGA_CONTROLLER_mReadSlaveReg0(baseaddr, 0);
  ...
  VGA_CONTROLLER_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = VGA_CONTROLLER_mReadSlaveReg1(baseaddr, 0);
  ...
  VGA_CONTROLLER_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = VGA_CONTROLLER_mReadSlaveReg2(baseaddr, 0);
  ...
  VGA_CONTROLLER_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = VGA_CONTROLLER_mReadSlaveReg3(baseaddr, 0);
  ...
  VGA_CONTROLLER_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = VGA_CONTROLLER_mReadSlaveReg4(baseaddr, 0);
  ...
  VGA_CONTROLLER_mWriteSlaveReg5(baseaddr, 0, 6);
  Reg32Value = VGA_CONTROLLER_mReadSlaveReg5(baseaddr, 0);
  ...
  VGA_CONTROLLER_mWriteSlaveReg6(baseaddr, 0, 7);
  Reg32Value = VGA_CONTROLLER_mReadSlaveReg6(baseaddr, 0);
  ...
  VGA_CONTROLLER_mWriteSlaveReg7(baseaddr, 0, 8);
  Reg32Value = VGA_CONTROLLER_mReadSlaveReg7(baseaddr, 0);
  ...
  VGA_CONTROLLER_mWriteSlaveReg8(baseaddr, 0, 9);
  Reg32Value = VGA_CONTROLLER_mReadSlaveReg8(baseaddr, 0);
  ...
  VGA_CONTROLLER_mWriteSlaveReg9(baseaddr, 0, 10);
  Reg32Value = VGA_CONTROLLER_mReadSlaveReg9(baseaddr, 0);
