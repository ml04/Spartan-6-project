...
Peripheral Summary:
  ...
  XPS project / EDK repository               : D:\DRS\KV_Lekic\EDK
  logical library name                       : vga_controller_v1_00_a
  top name                                   : vga_controller
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- XPS interface file(s)
  ...
  data/vga_controller_v2_1_0.mpd
  ...
  data/vga_controller_v2_1_0.pao
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/vga_controller_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/vga_controller_v2_1_0.tcl
...
plbv46_slave_single_v1_01_a
	D:\DRS\KV_Lekic\EDK\C:\Xilinx\14.7\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf
